...
df.merge <- Reduce(function(x, y) merge(x, y, all=TRUE), list(merged.data.ad,merged.data.bg,merged.data.ch,merged.data.lo,merged.data.ol,merged.data.rn,merged.data.ws,merged.data.wd,merged.data.cl,merged.data.fk))
