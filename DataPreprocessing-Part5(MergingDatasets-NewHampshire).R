...
df.merge <- Reduce(function(x, y) merge(x, y, all=TRUE), list(merged.data.bp,merged.data.ce,merged.data.co,merged.data.gf,merged.data.hb,merged.data.mk,merged.data.sf,merged.data.rc))
