...
setwd("E:/Purdue University/Spring 2018/IE 590 - Predictive Modeling/Final Project/Data Preprocessing - Part7(Merging Population with Dataset)/MA")
...
df.merge <- Reduce(function(x, y) merge(x, y, all=TRUE), list(merged.data.be,merged.data.bo,merged.data.bs,merged.data.dk,merged.data.ex,merged.data.fk,merged.data.hp,merged.data.mx,merged.data.no,merged.data.nt,merged.data.py,merged.data.sk,merged.data.wc))
write.csv(df.merge,"MA.csv",row.names = FALSE)
