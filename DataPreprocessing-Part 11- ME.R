...
setwd("E:/Purdue University/Spring 2018/IE 590 - Predictive Modeling/Final Project/Data Preprocessing - Part11(Population and parameters)/ME")
...
############################ Mapping the ME - Franklin Population with Dates ############################ 
# Read the CSV file and import it to a dataframe.
me.population <- read.csv("ME-PopulationCounty.csv", header = TRUE)
me.population
...
me.franklin.merged <- rbind(me.population.2011,me.population.2012,me.population.2013,me.population.2014,me.population.2015,me.population.2016,me.population.2017)
me.franklin.merged
write.csv(me.franklin.merged,"ME-Franklin-Population.csv", row.names = FALSE)


# Reading the csv that was generated in the previous step.
me.franklin.population <- read.csv("ME-Franklin-Population.csv",header = TRUE)


# Reading the csv that contains all the parameters
me.franklin <- read.csv("ME-Franklin.csv",header = TRUE)
me.franklin


# Merge the Dataset based on Dates.
merged.data.fr <- merge(x=me.franklin[,c(1:22)],y=me.franklin.population[,c(1,4)],by.x="Date",by.y="Date")
write.csv(merged.data.fr,"ME-Franklin-Final.csv", row.names = FALSE)
...
me.population.2011 <- data.frame(Date = seq(as.Date("2011-01-01"),as.Date("2011-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Piscataquis",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2011[11]))
)

me.population.2012 <- data.frame(Date = seq(as.Date("2012-01-01"),as.Date("2012-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Piscataquis",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2012[11]))
)

me.population.2013 <- data.frame(Date = seq(as.Date("2013-01-01"),as.Date("2013-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Piscataquis",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2013[11]))
)

me.population.2014 <- data.frame(Date = seq(as.Date("2014-01-01"),as.Date("2014-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Piscataquis",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2014[11]))
)

me.population.2015 <- data.frame(Date = seq(as.Date("2015-01-01"),as.Date("2015-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Piscataquis",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2015[11]))
)

me.population.2016 <- data.frame(Date = seq(as.Date("2016-01-01"),as.Date("2016-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Piscataquis",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2016[11]))
)
...
############################ Mapping the ME - Sagadahoc Population with Dates ############################ 
# Read the CSV file and import it to a dataframe.
me.population <- read.csv("ME-PopulationCounty.csv", header = TRUE)
me.population
...
me.population.2011 <- data.frame(Date = seq(as.Date("2011-01-01"),as.Date("2011-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Sagadahoc",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2011[12]))
)

me.population.2012 <- data.frame(Date = seq(as.Date("2012-01-01"),as.Date("2012-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Sagadahoc",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2012[12]))
)

me.population.2013 <- data.frame(Date = seq(as.Date("2013-01-01"),as.Date("2013-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Sagadahoc",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2013[12]))
)

me.population.2014 <- data.frame(Date = seq(as.Date("2014-01-01"),as.Date("2014-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Sagadahoc",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2014[12]))
)

me.population.2015 <- data.frame(Date = seq(as.Date("2015-01-01"),as.Date("2015-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Sagadahoc",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2015[12]))
)

me.population.2016 <- data.frame(Date = seq(as.Date("2016-01-01"),as.Date("2016-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Sagadahoc",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2016[12]))
)
...
me.sagadahoc.merged <- rbind(me.population.2011,me.population.2012,me.population.2013,me.population.2014,me.population.2015,me.population.2016,me.population.2017)
me.sagadahoc.merged
write.csv(me.sagadahoc.merged,"ME-Sagadahoc-Population.csv", row.names = FALSE)


# Reading the csv that was generated in the previous step.
me.sagadahoc.population <- read.csv("ME-Sagadahoc-Population.csv",header = TRUE)


# Reading the csv that contains all the parameters
me.sagadahoc <- read.csv("ME-Sagadahoc.csv",header = TRUE)
me.sagadahoc


# Merge the Dataset based on Dates.
merged.data.sg <- merge(x=me.sagadahoc[,c(1:22)],y=me.sagadahoc.population[,c(1,4)],by.x="Date",by.y="Date")
write.csv(merged.data.sg,"ME-Sagadahoc-Final.csv", row.names = FALSE)
...
############################ Mapping the ME - Somerset Population with Dates ############################ 
# Read the CSV file and import it to a dataframe.
me.population <- read.csv("ME-PopulationCounty.csv", header = TRUE)
me.population
...
me.population.2011 <- data.frame(Date = seq(as.Date("2011-01-01"),as.Date("2011-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Somerset",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2011[13]))
)

me.population.2012 <- data.frame(Date = seq(as.Date("2012-01-01"),as.Date("2012-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Somerset",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2012[13]))
)

me.population.2013 <- data.frame(Date = seq(as.Date("2013-01-01"),as.Date("2013-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Somerset",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2013[13]))
)

me.population.2014 <- data.frame(Date = seq(as.Date("2014-01-01"),as.Date("2014-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Somerset",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2014[13]))
)

me.population.2015 <- data.frame(Date = seq(as.Date("2015-01-01"),as.Date("2015-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Somerset",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2015[13]))
)

me.population.2016 <- data.frame(Date = seq(as.Date("2016-01-01"),as.Date("2016-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Somerset",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2016[13]))
)
...
me.somerset.merged <- rbind(me.population.2011,me.population.2012,me.population.2013,me.population.2014,me.population.2015,me.population.2016,me.population.2017)
me.somerset.merged
write.csv(me.somerset.merged,"ME-Somerset-Population.csv", row.names = FALSE)


# Reading the csv that was generated in the previous step.
me.somerset.population <- read.csv("ME-Somerset-Population.csv",header = TRUE)


# Reading the csv that contains all the parameters
me.somerset <- read.csv("ME-Somerset.csv",header = TRUE)
me.somerset


# Merge the Dataset based on Dates.
merged.data.sr <- merge(x=me.somerset[,c(1:22)],y=me.somerset.population[,c(1,4)],by.x="Date",by.y="Date")
write.csv(merged.data.sr,"ME-Somerset-Final.csv", row.names = FALSE)
...
############################ Mapping the ME - Waldo Population with Dates ############################ 
# Read the CSV file and import it to a dataframe.
me.population <- read.csv("ME-PopulationCounty.csv", header = TRUE)
me.population
...
me.population.2011 <- data.frame(Date = seq(as.Date("2011-01-01"),as.Date("2011-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Waldo",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2011[14]))
)

me.population.2012 <- data.frame(Date = seq(as.Date("2012-01-01"),as.Date("2012-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Waldo",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2012[14]))
)

me.population.2013 <- data.frame(Date = seq(as.Date("2013-01-01"),as.Date("2013-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Waldo",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2013[14]))
)

me.population.2014 <- data.frame(Date = seq(as.Date("2014-01-01"),as.Date("2014-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Waldo",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2014[14]))
)

me.population.2015 <- data.frame(Date = seq(as.Date("2015-01-01"),as.Date("2015-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Waldo",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2015[14]))
)

me.population.2016 <- data.frame(Date = seq(as.Date("2016-01-01"),as.Date("2016-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Waldo",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2016[14]))
)
...
me.waldo.merged <- rbind(me.population.2011,me.population.2012,me.population.2013,me.population.2014,me.population.2015,me.population.2016,me.population.2017)
me.waldo.merged
write.csv(me.waldo.merged,"ME-Waldo-Population.csv", row.names = FALSE)


# Reading the csv that was generated in the previous step.
me.waldo.population <- read.csv("ME-Waldo-Population.csv",header = TRUE)


# Reading the csv that contains all the parameters
me.waldo <- read.csv("ME-Waldo.csv",header = TRUE)
me.waldo


# Merge the Dataset based on Dates.
merged.data.wl <- merge(x=me.waldo[,c(1:22)],y=me.waldo.population[,c(1,4)],by.x="Date",by.y="Date")
write.csv(merged.data.wl,"ME-Waldo-Final.csv", row.names = FALSE)
...
############################ Mapping the ME - Washington Population with Dates ############################ 
# Read the CSV file and import it to a dataframe.
me.population <- read.csv("ME-PopulationCounty.csv", header = TRUE)
me.population
...
me.population.2011 <- data.frame(Date = seq(as.Date("2011-01-01"),as.Date("2011-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Washington",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2011[15]))
)

me.population.2012 <- data.frame(Date = seq(as.Date("2012-01-01"),as.Date("2012-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Washington",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2012[15]))
)

me.population.2013 <- data.frame(Date = seq(as.Date("2013-01-01"),as.Date("2013-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Washington",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2013[15]))
)

me.population.2014 <- data.frame(Date = seq(as.Date("2014-01-01"),as.Date("2014-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Washington",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2014[15]))
)

me.population.2015 <- data.frame(Date = seq(as.Date("2015-01-01"),as.Date("2015-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Washington",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2015[15]))
)

me.population.2016 <- data.frame(Date = seq(as.Date("2016-01-01"),as.Date("2016-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "Washington",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2016[15]))
)
...
me.washington.merged <- rbind(me.population.2011,me.population.2012,me.population.2013,me.population.2014,me.population.2015,me.population.2016,me.population.2017)
me.washington.merged
write.csv(me.washington.merged,"ME-Washington-Population.csv", row.names = FALSE)


# Reading the csv that was generated in the previous step.
me.washington.population <- read.csv("ME-Washington-Population.csv",header = TRUE)


# Reading the csv that contains all the parameters
me.washington <- read.csv("ME-Washington.csv",header = TRUE)
me.washington


# Merge the Dataset based on Dates.
merged.data.wh <- merge(x=me.washington[,c(1:22)],y=me.washington.population[,c(1,4)],by.x="Date",by.y="Date")
write.csv(merged.data.wh,"ME-Washington-Final.csv", row.names = FALSE)
...
############################ Mapping the ME - York Population with Dates ############################ 
# Read the CSV file and import it to a dataframe.
me.population <- read.csv("ME-PopulationCounty.csv", header = TRUE)
me.population
...
me.population.2011 <- data.frame(Date = seq(as.Date("2011-01-01"),as.Date("2011-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "York",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2011[16]))
)

me.population.2012 <- data.frame(Date = seq(as.Date("2012-01-01"),as.Date("2012-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "York",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2012[16]))
)

me.population.2013 <- data.frame(Date = seq(as.Date("2013-01-01"),as.Date("2013-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "York",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2013[16]))
)

me.population.2014 <- data.frame(Date = seq(as.Date("2014-01-01"),as.Date("2014-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "York",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2014[16]))
)

me.population.2015 <- data.frame(Date = seq(as.Date("2015-01-01"),as.Date("2015-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "York",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2015[16]))
)

me.population.2016 <- data.frame(Date = seq(as.Date("2016-01-01"),as.Date("2016-12-31"), by = "days"),
                                 State = "ME", 
                                 County = "York",
                                 Population = as.numeric(gsub(",", "", me.population$POP_ESTIMATE_2016[16]))
)
...
me.york.merged <- rbind(me.population.2011,me.population.2012,me.population.2013,me.population.2014,me.population.2015,me.population.2016,me.population.2017)
me.york.merged
write.csv(me.york.merged,"ME-York-Population.csv", row.names = FALSE)


# Reading the csv that was generated in the previous step.
me.york.population <- read.csv("ME-York-Population.csv",header = TRUE)


# Reading the csv that contains all the parameters
me.york <- read.csv("ME-York.csv",header = TRUE)
me.york


# Merge the Dataset based on Dates.
merged.data.yk <- merge(x=me.york[,c(1:22)],y=me.york.population[,c(1,4)],by.x="Date",by.y="Date")
write.csv(merged.data.yk,"ME-York-Final.csv", row.names = FALSE)
...
df.merge <- Reduce(function(x, y) merge(x, y, all=TRUE), list(merged.data.ag,merged.data.ak,merged.data.cl,merged.data.fr,merged.data.hk,merged.data.kc,merged.data.kx,merged.data.ln,merged.data.ox,merged.data.pn,merged.data.pk,merged.data.sg,merged.data.sr,merged.data.wl,merged.data.wh,merged.data.yk))
df.merge.sorted <- df.merge[order(df.merge$COUNTY),]
write.csv(df.merge.sorted,"ME.csv",row.names = FALSE)
