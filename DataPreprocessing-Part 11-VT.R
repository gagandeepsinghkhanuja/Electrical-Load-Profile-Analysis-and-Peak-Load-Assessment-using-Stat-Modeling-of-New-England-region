...
setwd("E:/Purdue University/Spring 2018/IE 590 - Predictive Modeling/Final Project/Data Preprocessing - Part11(Population and parameters)/VT")
...
############################ Mapping the VT - Essex Population with Dates ############################ 
# Read the CSV file and import it to a dataframe.
vt.population <- read.csv("VT-PopulationCounty.csv", header = TRUE)
vt.population
...
vt.essex.merged <- rbind(vt.population.2011,vt.population.2012,vt.population.2013,vt.population.2014,vt.population.2015,vt.population.2016,vt.population.2017)
vt.essex.merged
write.csv(vt.essex.merged,"VT-Essex-Population.csv", row.names = FALSE)


# Reading the csv that was generated in the previous step.
vt.essex.population <- read.csv("VT-Essex-Population.csv",header = TRUE)


# Reading the csv that contains all the parameters
vt.essex <- read.csv("VT-Essex.csv",header = TRUE)
vt.essex


# Merge the Dataset based on Dates.
merged.data.ex <- merge(x=vt.essex[,c(1:22)],y=vt.essex.population[,c(1,4)],by.x="Date",by.y="Date")
write.csv(merged.data.ex,"VT-Essex-Final.csv", row.names = FALSE)
...
############################ Mapping the VT - GrandIsle Population with Dates ############################ 
# Read the CSV file and import it to a dataframe.
vt.population <- read.csv("VT-PopulationCounty.csv", header = TRUE)
vt.population
...
vt.grandisle.merged <- rbind(vt.population.2011,vt.population.2012,vt.population.2013,vt.population.2014,vt.population.2015,vt.population.2016,vt.population.2017)
vt.grandisle.merged
write.csv(vt.grandisle.merged,"VT-GrandIsle-Population.csv", row.names = FALSE)


# Reading the csv that was generated in the previous step.
vt.grandisle.population <- read.csv("VT-GrandIsle-Population.csv",header = TRUE)


# Reading the csv that contains all the parameters
vt.grandisle <- read.csv("VT-GrandIsle.csv",header = TRUE)
vt.grandisle


# Merge the Dataset based on Dates.
merged.data.gi <- merge(x=vt.grandisle[,c(1:22)],y=vt.grandisle.population[,c(1,4)],by.x="Date",by.y="Date")
write.csv(merged.data.gi,"VT-GrandIsle-Final.csv", row.names = FALSE)
...
############################ Mapping the VT - Orange Population with Dates ############################ 
# Read the CSV file and import it to a dataframe.
vt.population <- read.csv("VT-PopulationCounty.csv", header = TRUE)
vt.population
...
vt.orange.merged <- rbind(vt.population.2011,vt.population.2012,vt.population.2013,vt.population.2014,vt.population.2015,vt.population.2016,vt.population.2017)
vt.orange.merged
write.csv(vt.orange.merged,"VT-Orange-Population.csv", row.names = FALSE)


# Reading the csv that was generated in the previous step.
vt.orange.population <- read.csv("VT-Orange-Population.csv",header = TRUE)


# Reading the csv that contains all the parameters
vt.orange <- read.csv("VT-Orange.csv",header = TRUE)
vt.orange


# Merge the Dataset based on Dates.
merged.data.or <- merge(x=vt.orange[,c(1:22)],y=vt.orange.population[,c(1,4)],by.x="Date",by.y="Date")
write.csv(merged.data.or,"VT-Orange-Final.csv", row.names = FALSE)
...
vt.population.2011 <- data.frame(Date = seq(as.Date("2011-01-01"),as.Date("2011-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Rutland",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2011[11]))
)

vt.population.2012 <- data.frame(Date = seq(as.Date("2012-01-01"),as.Date("2012-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Rutland",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2012[11]))
)

vt.population.2013 <- data.frame(Date = seq(as.Date("2013-01-01"),as.Date("2013-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Rutland",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2013[11]))
)

vt.population.2014 <- data.frame(Date = seq(as.Date("2014-01-01"),as.Date("2014-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Rutland",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2014[11]))
)

vt.population.2015 <- data.frame(Date = seq(as.Date("2015-01-01"),as.Date("2015-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Rutland",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2015[11]))
)

vt.population.2016 <- data.frame(Date = seq(as.Date("2016-01-01"),as.Date("2016-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Rutland",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2016[11]))
)
...
vt.population.2011 <- data.frame(Date = seq(as.Date("2011-01-01"),as.Date("2011-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Washington",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2011[12]))
)

vt.population.2012 <- data.frame(Date = seq(as.Date("2012-01-01"),as.Date("2012-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Washington",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2012[12]))
)

vt.population.2013 <- data.frame(Date = seq(as.Date("2013-01-01"),as.Date("2013-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Washington",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2013[12]))
)

vt.population.2014 <- data.frame(Date = seq(as.Date("2014-01-01"),as.Date("2014-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Washington",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2014[12]))
)

vt.population.2015 <- data.frame(Date = seq(as.Date("2015-01-01"),as.Date("2015-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Washington",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2015[12]))
)

vt.population.2016 <- data.frame(Date = seq(as.Date("2016-01-01"),as.Date("2016-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Washington",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2016[12]))
)
...
############################ Mapping the VT - Windham Population with Dates ############################ 
# Read the CSV file and import it to a dataframe.
vt.population <- read.csv("VT-PopulationCounty.csv", header = TRUE)
vt.population
...
vt.population.2011 <- data.frame(Date = seq(as.Date("2011-01-01"),as.Date("2011-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Windham",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2011[13]))
)

vt.population.2012 <- data.frame(Date = seq(as.Date("2012-01-01"),as.Date("2012-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Windham",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2012[13]))
)

vt.population.2013 <- data.frame(Date = seq(as.Date("2013-01-01"),as.Date("2013-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Windham",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2013[13]))
)

vt.population.2014 <- data.frame(Date = seq(as.Date("2014-01-01"),as.Date("2014-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Windham",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2014[13]))
)

vt.population.2015 <- data.frame(Date = seq(as.Date("2015-01-01"),as.Date("2015-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Windham",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2015[13]))
)

vt.population.2016 <- data.frame(Date = seq(as.Date("2016-01-01"),as.Date("2016-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Windham",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2016[13]))
)
...
vt.windham.merged <- rbind(vt.population.2011,vt.population.2012,vt.population.2013,vt.population.2014,vt.population.2015,vt.population.2016,vt.population.2017)
vt.windham.merged
write.csv(vt.windham.merged,"VT-Windham-Population.csv", row.names = FALSE)


# Reading the csv that was generated in the previous step.
vt.windham.population <- read.csv("VT-Windham-Population.csv",header = TRUE)


# Reading the csv that contains all the parameters
vt.windham <- read.csv("VT-Windham.csv",header = TRUE)
vt.windham


# Merge the Dataset based on Dates.
merged.data.wa <- merge(x=vt.windham[,c(1:22)],y=vt.windham.population[,c(1,4)],by.x="Date",by.y="Date")
write.csv(merged.data.wa,"VT-Windham-Final.csv", row.names = FALSE)
...
vt.population.2011 <- data.frame(Date = seq(as.Date("2011-01-01"),as.Date("2011-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Windsor",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2011[14]))
)

vt.population.2012 <- data.frame(Date = seq(as.Date("2012-01-01"),as.Date("2012-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Windsor",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2012[14]))
)

vt.population.2013 <- data.frame(Date = seq(as.Date("2013-01-01"),as.Date("2013-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Windsor",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2013[14]))
)

vt.population.2014 <- data.frame(Date = seq(as.Date("2014-01-01"),as.Date("2014-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Windsor",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2014[14]))
)

vt.population.2015 <- data.frame(Date = seq(as.Date("2015-01-01"),as.Date("2015-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Windsor",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2015[14]))
)

vt.population.2016 <- data.frame(Date = seq(as.Date("2016-01-01"),as.Date("2016-12-31"), by = "days"),
                                 State = "VT", 
                                 County = "Windsor",
                                 Population = as.numeric(gsub(",", "", vt.population$POP_ESTIMATE_2016[14]))
)
...
##################### Merging all the dataframes in Vermont ################### 
df.merge <- Reduce(function(x, y) merge(x, y, all=TRUE), list(merged.data.ad,merged.data.bg,merged.data.cd,merged.data.ct,merged.data.ex,merged.data.fk,merged.data.gi,merged.data.lm,merged.data.or,merged.data.os,merged.data.rl,merged.data.wh,merged.data.wa,merged.data.wd))
df.merge.sorted <- df.merge[order(df.merge$COUNTY),]
write.csv(df.merge.sorted,"VT.csv",row.names = FALSE)
