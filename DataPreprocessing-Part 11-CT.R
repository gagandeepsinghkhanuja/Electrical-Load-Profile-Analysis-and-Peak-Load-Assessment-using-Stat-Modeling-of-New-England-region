...
setwd("E:/Purdue University/Spring 2018/IE 590 - Predictive Modeling/Final Project/Data Preprocessing - Part11(Population and parameters)/CT")
...
############################ Mapping the CT - Litchfield Population with Dates ############################ 
# Read the CSV file and import it to a dataframe.
ct.population <- read.csv("CT-PopulationCounty.csv", header = TRUE)
ct.population
...
ct.population.2011 <- data.frame(Date = seq(as.Date("2011-01-01"),as.Date("2011-12-31"), by = "days"),
                                 State = "CT", 
                                 County = "Litchfield",
                                 Population = as.numeric(gsub(",", "", ct.population$POP_ESTIMATE_2011[3]))
)

ct.population.2012 <- data.frame(Date = seq(as.Date("2012-01-01"),as.Date("2012-12-31"), by = "days"),
                                 State = "CT", 
                                 County = "Litchfield",
                                 Population = as.numeric(gsub(",", "", ct.population$POP_ESTIMATE_2012[3]))
)

ct.population.2013 <- data.frame(Date = seq(as.Date("2013-01-01"),as.Date("2013-12-31"), by = "days"),
                                 State = "CT", 
                                 County = "Litchfield",
                                 Population = as.numeric(gsub(",", "", ct.population$POP_ESTIMATE_2013[3]))
)

ct.population.2014 <- data.frame(Date = seq(as.Date("2014-01-01"),as.Date("2014-12-31"), by = "days"),
                                 State = "CT", 
                                 County = "Litchfield",
                                 Population = as.numeric(gsub(",", "", ct.population$POP_ESTIMATE_2014[3]))
)

ct.population.2015 <- data.frame(Date = seq(as.Date("2015-01-01"),as.Date("2015-12-31"), by = "days"),
                                 State = "CT", 
                                 County = "Litchfield",
                                 Population = as.numeric(gsub(",", "", ct.population$POP_ESTIMATE_2015[3]))
)

ct.population.2016 <- data.frame(Date = seq(as.Date("2016-01-01"),as.Date("2016-12-31"), by = "days"),
                                 State = "CT", 
                                 County = "Litchfield",
                                 Population = as.numeric(gsub(",", "", ct.population$POP_ESTIMATE_2016[3]))
)
...
ct.Litchfield.merged <- rbind(ct.population.2011,ct.population.2012,ct.population.2013,ct.population.2014,ct.population.2015,ct.population.2016,ct.population.2017)
ct.Litchfield.merged
write.csv(ct.Litchfield.merged,"CT-Litchfield-Population.csv", row.names = FALSE)


# Reading the csv that was generated in the previous step.
ct.Litchfield.population <- read.csv("CT-Litchfield-Population.csv",header = TRUE)


# Reading the csv that contains all the parameters
ct.Litchfield <- read.csv("CT-Litchfield.csv",header = TRUE)
ct.Litchfield


# Merge the Dataset based on Dates.
merged.data.lf <- merge(x=ct.Litchfield[,c(1:22)],y=ct.Litchfield.population[,c(1,4)],by.x="Date",by.y="Date")
write.csv(merged.data.lf,"CT-Litchfield-Final.csv", row.names = FALSE)
...
############################ Mapping the CT - New London Population with Dates ############################ 
# Read the CSV file and import it to a dataframe.
ct.population <- read.csv("CT-PopulationCounty.csv", header = TRUE)
ct.population
...
ct.population.2011 <- data.frame(Date = seq(as.Date("2011-01-01"),as.Date("2011-12-31"), by = "days"),
                                 State = "CT", 
                                 County = "New London",
                                 Population = as.numeric(gsub(",", "", ct.population$POP_ESTIMATE_2011[6]))
)

ct.population.2012 <- data.frame(Date = seq(as.Date("2012-01-01"),as.Date("2012-12-31"), by = "days"),
                                 State = "CT", 
                                 County = "New London",
                                 Population = as.numeric(gsub(",", "", ct.population$POP_ESTIMATE_2012[6]))
)

ct.population.2013 <- data.frame(Date = seq(as.Date("2013-01-01"),as.Date("2013-12-31"), by = "days"),
                                 State = "CT", 
                                 County = "New London",
                                 Population = as.numeric(gsub(",", "", ct.population$POP_ESTIMATE_2013[6]))
)

ct.population.2014 <- data.frame(Date = seq(as.Date("2014-01-01"),as.Date("2014-12-31"), by = "days"),
                                 State = "CT", 
                                 County = "New London",
                                 Population = as.numeric(gsub(",", "", ct.population$POP_ESTIMATE_2014[6]))
)

ct.population.2015 <- data.frame(Date = seq(as.Date("2015-01-01"),as.Date("2015-12-31"), by = "days"),
                                 State = "CT", 
                                 County = "New London",
                                 Population = as.numeric(gsub(",", "", ct.population$POP_ESTIMATE_2015[6]))
)

ct.population.2016 <- data.frame(Date = seq(as.Date("2016-01-01"),as.Date("2016-12-31"), by = "days"),
                                 State = "CT", 
                                 County = "New London",
                                 Population = as.numeric(gsub(",", "", ct.population$POP_ESTIMATE_2016[6]))
)
...
ct.newlondon.merged <- rbind(ct.population.2011,ct.population.2012,ct.population.2013,ct.population.2014,ct.population.2015,ct.population.2016,ct.population.2017)
ct.newlondon.merged
write.csv(ct.newlondon.merged,"CT-NewLondon-Population.csv", row.names = FALSE)


# Reading the csv that was generated in the previous step.
ct.newlondon.population <- read.csv("CT-NewLondon-Population.csv",header = TRUE)


# Reading the csv that contains all the parameters
ct.newlondon <- read.csv("CT-NewLondon.csv",header = TRUE)
ct.newlondon


# Merge the Dataset based on Dates.
merged.data.nl <- merge(x=ct.newlondon[,c(1:22)],y=ct.newlondon.population[,c(1,4)],by.x="Date",by.y="Date")
write.csv(merged.data.nl,"CT-NewLondon-Final.csv", row.names = FALSE)
...
############################ Mapping the CT - Tolland Population with Dates ############################ 
# Read the CSV file and import it to a dataframe.
ct.population <- read.csv("CT-PopulationCounty.csv", header = TRUE)
ct.population
...
ct.population.2011 <- data.frame(Date = seq(as.Date("2011-01-01"),as.Date("2011-12-31"), by = "days"),
                                 State = "CT", 
                                 County = "Tolland",
                                 Population = as.numeric(gsub(",", "", ct.population$POP_ESTIMATE_2011[7]))
)

ct.population.2012 <- data.frame(Date = seq(as.Date("2012-01-01"),as.Date("2012-12-31"), by = "days"),
                                 State = "CT", 
                                 County = "Tolland",
                                 Population = as.numeric(gsub(",", "", ct.population$POP_ESTIMATE_2012[7]))
)

ct.population.2013 <- data.frame(Date = seq(as.Date("2013-01-01"),as.Date("2013-12-31"), by = "days"),
                                 State = "CT", 
                                 County = "Tolland",
                                 Population = as.numeric(gsub(",", "", ct.population$POP_ESTIMATE_2013[7]))
)

ct.population.2014 <- data.frame(Date = seq(as.Date("2014-01-01"),as.Date("2014-12-31"), by = "days"),
                                 State = "CT", 
                                 County = "Tolland",
                                 Population = as.numeric(gsub(",", "", ct.population$POP_ESTIMATE_2014[7]))
)

ct.population.2015 <- data.frame(Date = seq(as.Date("2015-01-01"),as.Date("2015-12-31"), by = "days"),
                                 State = "CT", 
                                 County = "Tolland",
                                 Population = as.numeric(gsub(",", "", ct.population$POP_ESTIMATE_2015[7]))
)

ct.population.2016 <- data.frame(Date = seq(as.Date("2016-01-01"),as.Date("2016-12-31"), by = "days"),
                                 State = "CT", 
                                 County = "Tolland",
                                 Population = as.numeric(gsub(",", "", ct.population$POP_ESTIMATE_2016[7]))
)
...
ct.tolland.merged <- rbind(ct.population.2011,ct.population.2012,ct.population.2013,ct.population.2014,ct.population.2015,ct.population.2016,ct.population.2017)
ct.tolland.merged
write.csv(ct.tolland.merged,"CT-Tolland-Population.csv", row.names = FALSE)


# Reading the csv that was generated in the previous step.
ct.tolland.population <- read.csv("CT-Tolland-Population.csv",header = TRUE)


# Reading the csv that contains all the parameters
ct.tolland <- read.csv("CT-Tolland.csv",header = TRUE)
ct.tolland


# Merge the Dataset based on Dates.
merged.data.tl <- merge(x=ct.tolland[,c(1:22)],y=ct.tolland.population[,c(1,4)],by.x="Date",by.y="Date")
write.csv(merged.data.tl,"CT-Tolland-Final.csv", row.names = FALSE)
...
df.merge <- Reduce(function(x, y) merge(x, y, all=TRUE), list(merged.data.fd,merged.data.hf,merged.data.lf,merged.data.mx,merged.data.nh,merged.data.nl,merged.data.tl,merged.data.wd))
df.merge.sorted <- df.merge[order(df.merge$COUNTY),]
write.csv(df.merge.sorted,"CT.csv",row.names = FALSE)
